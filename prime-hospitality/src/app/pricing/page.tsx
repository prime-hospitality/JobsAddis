...
// Shared brand accent -- JobsAdis deep blue, matching the employer dashboard.
const BRAND = "#1B5CBF";
const BRAND_SUBTLE = "#EEF3FC";
const INK = "#141821";
...
function FeatureRow({ label, price, dark }: { label: string; price?: string; dark?: boolean }) {
  return (
    <li style={{ display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: 15, gap: 12, fontFamily: "'Inter', sans-serif", color: dark ? "#E2E5EC" : "#343A46" }}>
...
export default async function PricingPage() {
  ...
  const headingFont = "'Poppins', 'Inter', sans-serif";
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F7F8FA", fontFamily: bodyFont }}>
      ...
      {/* Navigation */}
      <nav className="pr-nav" style={{ padding: "22px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #E2E5EC", backgroundColor: "#fff" }}>
        <div style={{ fontSize: 19, fontWeight: 800, color: INK, display: "flex", alignItems: "center", gap: 10, fontFamily: headingFont, letterSpacing: "-0.01em" }}>
          <img src="/logo.webp" alt="Prime Hospitality Logo" style={{ width: 34, height: 34, objectFit: "contain" }} />
      ...
      <div className="pr-hero" style={{ padding: "72px 24px 52px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 17, color: "#6E7686", maxWidth: 560, margin: "0 auto", lineHeight: 1.6, fontFamily: bodyFont }}>
      ...
      <div className="pr-cards-wrap" style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px 44px" }}>
        <div style={{
          ...
          <div className="pr-card" style={{
            ...
            <p style={{ fontSize: 14, color: "#6E7686", marginBottom: 26, minHeight: 40, lineHeight: 1.5 }}>
            ...
            <div style={{ marginBottom: 28, display: "flex", alignItems: "baseline", gap: 8 }}>
              <span style={{ fontSize: 15, fontWeight: 600, color: "#9AA1B1" }}>From</span>
              <span style={{ fontSize: 32, fontWeight: 800, color: INK, letterSpacing: "-0.02em", whiteSpace: "nowrap", fontFamily: headingFont }}>
                {premiumFrom}
              </span>
              <span style={{ fontSize: 15, color: "#9AA1B1", fontWeight: 500 }}>ETB</span>
            </div>
          ...
          <div className="pr-card" style={{
            background: `linear-gradient(135deg, ${INK} 0%, #212630 100%)`,
            borderRadius: 20,
            padding: "40px 36px",
            border: "1px solid #212630",
            boxShadow: "0 20px 40px -12px rgba(20, 24, 33, 0.35)",
            position: "relative",
            display: "flex",
            flexDirection: "column"
          }}>
            <div style={{
              ...
              boxShadow: "0 4px 14px rgba(242, 240, 18, 0.38)"
            }}>
              Most Popular
            </div>
            <h3 style={{ fontSize: 19, fontWeight: 700, color: "#fff", marginBottom: 8, fontFamily: headingFont }}>Standard Packages</h3>
            <p style={{ fontSize: 14, color: "#9AA1B1", marginBottom: 26, minHeight: 40, lineHeight: 1.5 }}>
            ...
            <div style={{ backgroundColor: "rgba(255,255,255,0.06)", padding: 14, borderRadius: 12, marginTop: "auto", display: "flex", gap: 10, alignItems: "flex-start" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#85A9E6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 2 }}><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
              <p style={{ fontSize: 13, color: "#CBD0DA", lineHeight: 1.55, margin: 0 }}>
          ...
          <div className="pr-card" style={{
            ...
            <p style={{ fontSize: 14, color: "#6E7686", marginBottom: 26, minHeight: 40, lineHeight: 1.5 }}>Extra services for your business, tailored to your needs.</p>
            <div style={{ marginBottom: 28, display: "flex", alignItems: "baseline", gap: 8 }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 16, flexGrow: 1 }}>
              ...
              <div style={{ fontSize: 12, fontWeight: 700, color: "#9AA1B1", textTransform: "uppercase", letterSpacing: "0.06em" }}>We Also Provide</div>
        ...
        <div className="pr-details-card" style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 36 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: 12, color: "#6E7686", fontWeight: 600 }}>Company Name</span>
                  <span style={{ fontSize: 15, color: INK, fontWeight: 600 }}>{config.companyName}</span>
                </div>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: 12, color: "#6E7686", fontWeight: 600 }}>Bank</span>
                  <span style={{ fontSize: 15, color: INK, fontWeight: 600 }}>{config.bankName}</span>
                </div>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: 12, color: "#6E7686", fontWeight: 600 }}>Account No</span>
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                <h4 style={{ fontSize: 16, fontWeight: 700, color: INK, marginBottom: 16, display: "flex", alignItems: "center", gap: 8, fontFamily: headingFont }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B45309" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                  Important Information
                </h4>
                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                  <li style={{ display: "flex", alignItems: "flex-start", gap: 10, fontSize: 14, color: "#4C5361", lineHeight: 1.5 }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9AA1B1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 2 }}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                    <span>Posting days for any package are <strong>consecutive days</strong> starting from the activation date.</span>
                  </li>
                  <li style={{ display: "flex", alignItems: "flex-start", gap: 10, fontSize: 14, color: "#4C5361", lineHeight: 1.5 }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9AA1B1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 2 }}><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
                    <span>Call us for further discussion regarding consulting and custom services.</span>
                  </li>
                </ul>
              </div>

              <div style={{ marginTop: 24, padding: "16px 20px", backgroundColor: "#F7F8FA", borderRadius: 12, border: "1px solid #E2E5EC" }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: "#6E7686", marginBottom: 10, textTransform: "uppercase", letterSpacing: "0.05em" }}>Contact Us</div>
          ...
          <div style={{ borderTop: "1px solid #E2E5EC", paddingTop: 24, textAlign: "center", color: "#6E7686", fontSize: 15 }}>
            Thank you,<br/>
