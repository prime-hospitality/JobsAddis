    ...
    <div style={{ maxWidth: 1200, margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16, marginBottom: 24 }}>
        {[0, 1, 2, 3].map((i) => (
          <div
            key={i}
            style={{ background: "#fff", borderRadius: 12, padding: "20px 22px", border: "1px solid #E2E5EC", display: "flex", alignItems: "center", gap: 16, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}
          >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        {[0, 1].map((panel) => (
          <div
            key={panel}
            style={{ background: "#fff", borderRadius: 14, border: "1px solid #E2E5EC", overflow: "hidden", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}
          >
            ...
            <div style={{ padding: "8px 20px 20px" }}>
              {[0, 1, 2, 3].map((row) => (
                <div key={row} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 0", borderBottom: row < 3 ? "1px solid #F7F8FA" : "none" }}>
