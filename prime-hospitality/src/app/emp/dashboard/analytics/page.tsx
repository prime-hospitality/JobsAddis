  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e2e8f0", padding: "48px 32px", textAlign: "center", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
        ...
        <h2 style={{ fontSize: 22, fontWeight: 800, color: "#0f172a", marginBottom: 8 }}>Analytics</h2>
        <p style={{ fontSize: 15, color: "#64748b", marginBottom: 24 }}>Detailed analytics and performance reports for your job postings. Coming soon.</p>
